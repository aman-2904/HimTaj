...
export default function Navbar({
  ...
  useEffect(() => {
    const handleScroll = () => {
      setScrolled(window.scrollY > 0); // true when user scrolls down
    };
  ...
  const isHeaderActive =
    isHovered || isDrawerOpen || isSearchOpen || isLoginOpen || isWhite || scrolled;

  const iconColor = isHeaderActive ? "black" : "black";
